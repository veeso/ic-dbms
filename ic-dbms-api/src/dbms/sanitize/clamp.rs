use crate::prelude::{IcDbmsResult, Sanitize, Value};
...
///
/// ```rust
/// use ic_dbms_api::prelude::{ClampSanitizer, Value, Sanitize as _};
///
        ...
        match value {
            Value::Int32(num) => {
                ...
                match clamped {
                    ...
                    Err(_) => Err(crate::prelude::IcDbmsError::Sanitize(
...
///
/// ```rust
/// use ic_dbms_api::prelude::{ClampUnsignedSanitizer, Value, Sanitize as _};
///
